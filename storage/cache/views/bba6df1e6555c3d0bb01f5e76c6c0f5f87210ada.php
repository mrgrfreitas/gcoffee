        ...
        <div class="container">
            <div class="site-header-inner">
                <div class="brand header-brand">
                    <h3 class="m-0">
                        <a href="#" style="text-decoration: none; color: aqua">
                            gCoffee - Framework
                        </a>
                    </h3>
                </div>
        ...
        <section class="hero">
            <div class="container">
                <div class="hero-inner">
                    <div class="hero-copy">
                        <h1 class="hero-title mt-0">The PHP Structure for <span style="color: #0F8AFD">Web Development</span></h1>
                        <p class="hero-paragraph">gCoffee is a web application framework with expressive, elegant syntax. We’ve already laid the foundation — freeing you to create without sweating the small things.</p>
                        <div class="hero-cta"><a class="button button-primary" href="#">GET STARTED</a><a class="button" href="https://github.com/mrgrfreitas/gcoffee-framework">github</a></div>
                    </div>
    ...
    <footer class="site-footer">
        <div class="container">
            <div class="site-footer-inner">
                ...
                <div class="footer-copyright">&copy; <?php echo e(date('Y')); ?> gWorks <i>(gcoffee-framework)</i>, all rights reserved</div>
            </div>
        </div>
    </footer>
</div>
...
<?php /**PATH /opt/lampp/htdocs/gcoffee.framework/resources/views/welcome.blade.php ENDPATH**/ ?>